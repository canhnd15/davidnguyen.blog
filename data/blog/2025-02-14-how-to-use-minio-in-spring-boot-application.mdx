...
date: '2025-02-08'
lastmod: '2024-02-08'
tags: ['Spring Boot', 'Minio', 'AWS S3']
draft: false
summary: Trong bài viết này mình sẽ cùng các bạn tìm hiểu về Minio là một Object Storage cũng như cách sử dụng Minio trong ứng dụng Spring Boot để hỗ trợ các th
