...
Ngoài ra nếu các bạn nào quan tâm thì có thể tham khảo các bài viết khác cùng chủ đề Design Patterns được mình tổng hợp tại đây nhé.!

Bây giờ thì cùng bắt đầu bài viết hôm nay nào!
...
public class App {
    public static void main(String[] args) {
        ...
        House poorGuysHouse = new HouseBuilderImpl()
                ...
                .build();
        System.out.printf("%s%s%n", "POOR GUYS'S HOUSE: ", poorGuysHouse.toString());
        ...
        House commonGuysHouse = new HouseBuilderImpl()
                ...
                .build();
        System.out.printf("%s%s%n", "COMMON GUYS'S HOUSE: ", commonGuysHouse.toString());
        ...
        House richGuysHouse = new HouseBuilderImpl()
                ...
                .build();
        System.out.printf("%s%s%n", "RICH GUYS'S HOUSE: ", richGuysHouse.toString());
    }
}
```
...
```logs
POOR GUY'S HOUSE: windows=2, doors=1, walls=4, roof='made from bamboo', yard='null', swimmingPool='null', garage='null'
COMMON GUY'S HOUSE: windows=4, doors=1, walls=4, roof='made from steel', yard='30 square meters', swimmingPool='null', garage='null'
RICH GUY'S HOUSE: windows=8, doors=4, walls=4, roof='made from steel', yard='300 square meters', swimmingPool
```
