---
title: '[AWS] - Host a static Angular site on Amazon S3.'
date: '2024-09-13'
lastmod: '2024-09-13'
tags: ['AWS S3', 'Angular', 'cloud']
draft: false
...
- Typically, a static site built with Angular or another frontend framework will include an `index.html` file, which serves as the home or default page of the website. We need to specify this file, along with an `error.html` file for undefined resources, as shown in the image below.
