---
title: '[Java] - Simplify Resource Management With Try-With-Resources'
date: '2024-11-23'
lastmod: '2024-11-23'
tags: ['Java']
draft: false
...
```Java
public static void readTextFileByLineWithTryCatch(String fileName) {
    ...
    try {
        ...
        while (line != null) {
            i++;
            System.out.printf("Line %s : %s", i, line);
...
public class NetworkUtil {
    ...
    public static void main(String[] args) {
        // The host and port of the server we want to connect to
